...
HistoneBindingMotifHold<-tibble(sequence=c('EEDDEDEEDDDFKE', 'QSDTEDEVDSDFDI', 'EEIQDEEDDDDYVE', 'DGDLDLDDSEDFTV', 'ASDESEEEVSEYEA', 'YEPTEEECEWKPDEEDEISE', 'YEPTEEECEWKPDEEDEVSE', 'YEPTEEECEWKPDEEDEISE','EEECEWKPDEEDEISEELKE','EEECEWKPDEEDEVSEELKE',
                  'EEECEWKPDEEDEISEELKE', 'EDDGDDYVE','EEEVSEYEA', 'EEDGKEYEQ'), 
...
HistoneBindingMotif<-tibble(sequence=c('EEDDEDEEDDDFKE', 'QSDTEDEVDSDFDI', 'EEIQDEEDDDDYVE', 'DGDLDLDDSEDFTV', 'ASDESEEEVSEYEA', 'YEPTEEECEWKPDEEDEISE', 'YEPTEEECEWKPDEEDEVSE', 'YEPTEEECEWKPDEEDEISE','EEECEWKPDEEDEISEELKE','EEECEWKPDEEDEVSEELKE',
                                           'EEECEWKPDEEDEISEELKE', 'EDDGDDYVE','EEEVSEYEA', 'EEDGKEYEQ'), 
                                name=c('DEF/Y', 'DEF/Y', 'DEF/Y', 'DEF/Y', 'DEF/Y', 'Nap1L1 Hs_a', 'Nap1L1 Mm_a', 'Nap1L1 Bt_a', 'Nap1L1 Hs_b', 'Nap1L1 Mm_b', 'Nap1L1 Bt_b', 'Anp32E Hs', 'Spt16 Sc', 'YL1 Dm'))
